  ...
  Future<void> _updateData() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await _apiService.updateSupplier(widget.supplier.id!, updatedSupplier);

        if (!mounted) return;

        AppSnackBar.showSuccess(context, 'Supplier updated successfully!');
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.business_center_rounded, color: Colors.blue.shade700, size: 20),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.contacts_rounded, color: Colors.blue.shade700, size: 20),
                          const SizedBox(width: 8),
                          const Text(
                ...
                Container(
                  ...
                  child: SwitchListTile(
                    ...
                    subtitle: Text('Enable or disable this supplier', style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                    secondary: Container(
